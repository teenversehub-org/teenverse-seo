...
export const metadata = buildMetadata({
  title: "How to Start Freelancing as a Teen | Safe Beginner Roadmap",
  description: "Learn how to start freelancing as a teen with one digital skill, portfolio samples, verified profiles, guardian consent, safe payments, and real beginner projects.",
  path: "/how-to-start-freelancing-as-a-teen",
  keywords: [
    "teen freelancing roadmap",
...
const pageSchema = {
  ...
  '@type': "Article",
  headline: "How to Start Freelancing as a Teen | Safe Beginner Roadmap",
  name: "How to Start Freelancing as a Teen | Safe Beginner Roadmap",
  description: "Learn how to start freelancing as a teen with one digital skill, portfolio samples, verified profiles, guardian consent, safe payments, and real beginner projects.",
        ...
        <section className="relative isolate flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 pb-20 pt-32">
          ...
          <div className="tv-reveal relative z-10 mx-auto max-w-5xl text-center">
            ...
            <h1 className="text-4xl font-black leading-[1.08] tracking-tighter text-slate-950 dark:text-white sm:text-7xl md:text-8xl">
              {"Start Freelancing"} <br className="hidden md:block" />
              <span className="bg-gradient-to-r from-indigo-400 via-fuchsia-400 to-emerald-400 bg-clip-text text-transparent">
                {"With Trust and Proof"}
              </span>
            </h1>
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-relaxed text-slate-600 dark:text-slate-400 md:text-xl">
              {"Starting freelancing as a teen works best when the process is structured: choose one digital skill, build sample work, create a portfolio, verify your ability, involve guardians where needed, and use safer platform systems for communication and payments."}
            </p>
