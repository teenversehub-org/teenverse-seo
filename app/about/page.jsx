...
export const metadata = buildMetadata({
  title: "About TeenVerseHub | Teen Economic Ecosystem for Skills, Work, and Growth",
  description: "Learn how TeenVerseHub is building a teen-focused economic ecosystem for digital skills, safe earning, verified portfolios, startup collaboration, and future-ready growth.",
  path: "/about",
  keywords: [
    "about TeenVerseHub",
    "teen economic ecosystem",
    "teen future workforce platform",
...
const pageSchema = {
  ...
  '@type': "AboutPage",
  headline: "About TeenVerseHub | Teen Economic Ecosystem for Skills, Work, and Growth",
  name: "About TeenVerseHub | Teen Economic Ecosystem for Skills, Work, and Growth",
  description: "Learn how TeenVerseHub is building a teen-focused economic ecosystem for digital skills, safe earning, verified portfolios, startup collaboration, and future-ready growth.",
...
const pageFeatures = [
  {
    ...
    description: "TeenVerseHub helps teenagers move from learning a digital skill to proving it, applying it, earning safely, and building a visible professional identity.",
    span: "md:col-span-6",
  ...
  },
  {
    ...
    description: "The platform gives young talent a structured gateway into projects, startups, creators, internships, and future entrepreneurship instead of scattered informal DMs.",
    span: "md:col-span-6",
  ...
  },
  {
    ...
    description: "Guardian consent, KYC, moderation, reporting, and approved payment flows are part of the product vision because teen work needs stronger protection.",
    span: "md:col-span-5",
  ...
  },
  {
    ...
    description: "TeenVerseHub can evolve into a global teen talent network, verified youth workforce platform, startup incubator, and teen creator economy infrastructure.",
    span: "md:col-span-7",
...
const roadmapSteps = [
  {
    ...
    points: [
      ...
      "Complete consent and verification steps",
      "Learn safe communication habits"
    ]
  },
  {
    title: "Expansion",
    ...
    points: [
      "Work with startups and creators",
      "Build reviews and repeatable workflows",
      "Join learning and collaboration tracks",
    ...
    <>
      ...
      <main className="min-h-screen bg-[#f7f9ff] text-slate-950 selection:bg-indigo-200 selection:text-slate-950 transition-colors duration-500 dark:bg-[#030712] dark:text-white dark:selection:bg-indigo-500/30 dark:selection:text-indigo-200">
        <section className="relative isolate flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 pb-20 pt-32">
          ...
          <div className="tv-reveal relative z-10 mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-relaxed text-slate-600 dark:text-slate-400 md:text-xl">
              {"TeenVerseHub is a teen-focused digital platform designed to help teenagers learn, build skills, earn money, collaborate, and grow safely in the digital economy. The first focus is India, with a long-term vision of becoming a global ecosystem for young creators, developers, founders, and skilled students."}
            </p>
            <div className="mt-12 flex w-full flex-col items-center justify-center gap-4 sm:flex-row sm:gap-6">
              ...
              <a href={"/guardian-guide"} className="inline-flex w-full max-w-sm items-center justify-center gap-3 rounded-full border border-indigo-200 bg-white/70 px-8 py-4 text-base font-bold text-slate-900 shadow-sm backdrop-blur-lg transition-colors hover:bg-white dark:border-white/20 dark:bg-white/5 dark:text-white dark:hover:bg-white/10 dark:hover:text-white sm:w-auto">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="tv-reveal max-w-3xl">
              <h2 className="text-4xl font-black tracking-tight text-slate-950 dark:text-white sm:text-5xl">
                {"TeenVerseHub connects the parts teens usually have to solve alone."}
              </h2>
              <p className="mt-6 text-xl leading-relaxed text-slate-600 dark:text-slate-400">
                {"The platform is not just a job board. It combines identity, skill proof, portfolios, marketplace access, safer payments, moderation, learning, and community into one long-term teen growth system."}
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-24">
              <div className="tv-reveal lg:sticky lg:top-32 lg:col-span-5 lg:h-max">
                <h2 className="text-4xl font-black leading-tight tracking-tight text-slate-950 dark:text-white sm:text-5xl">{"Teenagers are already creating real value."}</h2>
                <p className="mt-6 text-lg leading-relaxed text-slate-600 dark:text-slate-400">{"Many teenagers can build apps, edit videos, design graphics, manage communities, use AI tools, create content channels, or start brands. The current economy rarely gives them a professional, protected place to turn that ability into real experience before adulthood."}</p>
              </div>
              <div className="flex flex-col gap-8 lg:col-span-7">
                <div className="tv-card-motion tv-reveal relative rounded-[2rem] border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white p-7 shadow-2xl shadow-indigo-100/70 backdrop-blur-xl dark:border-indigo-500/20 dark:bg-gradient-to-br dark:from-indigo-950/40 dark:to-slate-900/40 dark:shadow-2xl sm:rounded-[2.5rem] sm:p-10">
                  <div className="mb-6 flex items-center gap-4 border-b border-slate-200 pb-6 dark:border-white/10"><Briefcase className="h-8 w-8 text-indigo-400" /><h3 className="text-2xl font-black text-slate-950 dark:text-white">{"What We Believe"}</h3></div>
                ...
                <div className="tv-card-motion tv-reveal relative rounded-[2rem] border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-7 shadow-2xl shadow-emerald-100/70 backdrop-blur-xl dark:border-emerald-500/20 dark:bg-gradient-to-br dark:from-emerald-950/40 dark:to-slate-900/40 dark:shadow-2xl sm:rounded-[2.5rem] sm:p-10">
                  <div className="mb-6 flex items-center gap-4 border-b border-slate-200 pb-6 dark:border-white/10"><TrendingUp className="h-8 w-8 text-emerald-400" /><h3 className="text-2xl font-black text-slate-950 dark:text-white">{"What We Are Building"}</h3></div>
                  <p className="mb-6 text-lg text-slate-700 dark:text-slate-300">{"The product vision combines teen accounts, service listings, AI support, verification, guardian consent, payments, moderation, learning, and startup collaboration."}</p>
                  <ul className="space-y-4">{[
                    "Profiles, skills, portfolios, and reviews",
                    "AI recommendations and portfolio optimization",
                    "Verified badges and practical assessments",
                    "Courses, mentors, hackathons, and startup pathways"
        ...
        <section className="relative isolate mx-auto my-24 max-w-[1300px] overflow-hidden rounded-[3rem] border border-white/10 bg-[#090e1a] px-6 py-24 shadow-[0_40px_100px_rgba(0,0,0,0.6)] sm:my-32 sm:px-16 sm:py-32">
          ...
          <div className="tv-reveal relative z-10 mx-auto max-w-3xl text-center"><h2 className="text-4xl font-black tracking-tight text-white sm:text-5xl">{"From student skill to real-world confidence."}</h2><p className="mt-6 text-xl leading-relaxed text-slate-400">{"The ecosystem is designed to help teens grow step by step instead of chasing unsafe shortcuts."}</p></div>
          ...
          <div className="tv-reveal relative z-10 mt-12 rounded-[2rem] border border-rose-500/20 bg-rose-950/20 p-10 backdrop-blur-md"><div className="flex flex-col items-start gap-8 sm:flex-row sm:items-center"><div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-rose-500/20 text-rose-400"><AlertTriangle className="h-8 w-8" /></div><div><h4 className="text-2xl font-black text-white">{"One-Line Summary"}</h4><p className="mt-2 text-lg text-slate-400">{"TeenVerseHub is a secure AI-powered ecosystem where teenagers can learn, showcase skills, collaborate, and earn through real-world digital opportunities."}</p></div></div></div>
        </section>

        <section className="relative overflow-hidden bg-gradient-to-t from-[#0f172a] to-[#030712] px-6 py-24 text-center sm:py-32">
          <div className="tv-reveal relative z-10 mx-auto max-w-4xl"><h2 className="text-4xl font-black tracking-tight text-white sm:text-6xl">{"A safer launchpad for teen creators, developers, and founders."}</h2><p className="mx-auto mt-8 max-w-2xl text-xl leading-relaxed text-slate-400">{"The goal is to unlock opportunity while building trust systems that support teens, guardians, startups, and the wider digital economy."}</p><div className="mt-12 flex flex-col items-center justify-center gap-6 sm:flex-row"><a href={SITE.appUrl} className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-indigo-500 px-10 py-5 text-lg font-black text-white transition-all hover:bg-indigo-400 hover:shadow-[0_0_40px_rgba(99,102,241,0.4)] active:scale-95 sm:w-auto">{"Start Exploring"}</a><a href={"/safety"} className="inline-flex w-full items-center justify-center gap-3 rounded-full border border-white/20 bg-white/5 px-10 py-5 text-lg font-bold text-white backdrop-blur-lg transition-colors hover:bg-white/10 sm:w-auto">{"View Safety Model"}</a></div></div>
        </section>
      </main>
