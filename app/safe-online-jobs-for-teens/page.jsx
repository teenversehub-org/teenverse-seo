...
export const metadata = buildMetadata({
  title: "Safe Online Jobs for Teens | Avoid Scams and Earn With Protection",
  description: "Find safe online jobs for teens and learn how guardian consent, KYC, moderation, scam detection, and protected payments reduce risk for young freelancers.",
  path: "/safe-online-jobs-for-teens",
  keywords: [
    "safe online jobs for teens",
    "teen online job safety",
    "teen online safety",
...
const pageSchema = {
  ...
  '@type': "Article",
  headline: "Safe Online Jobs for Teens | Avoid Scams and Earn With Protection",
  name: "Safe Online Jobs for Teens | Avoid Scams and Earn With Protection",
  description: "Find safe online jobs for teens and learn how guardian consent, KYC, moderation, scam detection, and protected payments reduce risk for young freelancers.",
  author: { '@type': 'Organization', name: SITE.shortName },
  publisher: { '@type': 'Organization', name: SITE.shortName },
  mainEntityOfPage: `${SITE.baseUrl}/safe-online-jobs-for-teens`,
}
        ...
        <section className="relative isolate flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 pb-20 pt-32">
          ...
          <div className="tv-reveal relative z-10 mx-auto max-w-5xl text-center">
            ...
            <h1 className="text-4xl font-black leading-[1.08] tracking-tighter text-slate-950 dark:text-white sm:text-7xl md:text-8xl">
              {"Safe Online Jobs"} <br className="hidden md:block" />
