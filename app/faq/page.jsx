...
export const metadata = buildMetadata({
  title: "TeenVerseHub FAQ | Safety, Freelancing, Payments, Verification, and Guardians",
  description: "Answers to TeenVerseHub questions about teen freelancing, online jobs, guardian consent, KYC, AI moderation, payments, verification, and platform safety.",
  path: "/faq",
  keywords: [
    "TeenVerseHub FAQ",
...
const pageSchema = {
  ...
  '@type': "FAQPage",
  headline: "TeenVerseHub FAQ | Safety, Freelancing, Payments, Verification, and Guardians",
  name: "TeenVerseHub FAQ | Safety, Freelancing, Payments, Verification, and Guardians",
  description: "Answers to TeenVerseHub questions about teen freelancing, online jobs, guardian consent, KYC, AI moderation, payments, verification, and platform safety.",
    ...
    <>
      ...
      <main className="min-h-screen bg-[#f7f9ff] text-slate-950 selection:bg-indigo-200 selection:text-slate-950 transition-colors duration-500 dark:bg-[#030712] dark:text-white dark:selection:bg-indigo-500/30 dark:selection:text-indigo-200">
        <section className="relative isolate flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 pb-20 pt-32">
          ...
          <div className="tv-reveal relative z-10 mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-relaxed text-slate-600 dark:text-slate-400 md:text-xl">
              {"TeenVerseHub brings teen freelancing, online jobs, AI-powered matching, guardian consent, KYC, moderation, and protected payment workflows into one ecosystem. These answers explain the core platform ideas in practical terms."}
            </p>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="tv-reveal max-w-3xl">
              ...
              <p className="mt-6 text-xl leading-relaxed text-slate-600 dark:text-slate-400">
                {"These answers cover what TeenVerseHub is, how teens can earn, what guardians should know, how verification works, and why safety systems matter."}
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-24">
              <div className="tv-reveal lg:sticky lg:top-32 lg:col-span-5 lg:h-max">
                <h2 className="text-4xl font-black leading-tight tracking-tight text-slate-950 dark:text-white sm:text-5xl">{"The platform vision is broader than basic freelancing."}</h2>
                <p className="mt-6 text-lg leading-relaxed text-slate-600 dark:text-slate-400">{"TeenVerseHub is a future workforce ecosystem where teenagers can learn, build, collaborate, earn, network, and launch careers early with protection systems around them."}</p>
              </div>
              <div className="flex flex-col gap-8 lg:col-span-7">
                <div className="tv-card-motion tv-reveal relative rounded-[2rem] border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white p-7 shadow-2xl shadow-indigo-100/70 backdrop-blur-xl dark:border-indigo-500/20 dark:bg-gradient-to-br dark:from-indigo-950/40 dark:to-slate-900/40 dark:shadow-2xl sm:rounded-[2.5rem] sm:p-10">
                  <div className="mb-6 flex items-center gap-4 border-b border-slate-200 pb-6 dark:border-white/10"><Briefcase className="h-8 w-8 text-indigo-400" /><h3 className="text-2xl font-black text-slate-950 dark:text-white">{"Platform Basics"}</h3></div>
                  <ul className="space-y-4">{[
                    "TeenVerseHub is teen-focused and India-first",
                    "The long-term vision is global",
                    "It combines learning, work, and safety",
                    "It is not only a freelancing website"
                ...
                <div className="tv-card-motion tv-reveal relative rounded-[2rem] border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-7 shadow-2xl shadow-emerald-100/70 backdrop-blur-xl dark:border-emerald-500/20 dark:bg-gradient-to-br dark:from-emerald-950/40 dark:to-slate-900/40 dark:shadow-2xl sm:rounded-[2.5rem] sm:p-10">
                  <div className="mb-6 flex items-center gap-4 border-b border-slate-200 pb-6 dark:border-white/10"><TrendingUp className="h-8 w-8 text-emerald-400" /><h3 className="text-2xl font-black text-slate-950 dark:text-white">{"What Makes It Different"}</h3></div>
                  <p className="mb-6 text-lg text-slate-700 dark:text-slate-300">{"TeenVerseHub combines marketplace opportunity with AI support, guardian consent, KYC, moderation, payment protection, and learning pathways."}</p>
                  <ul className="space-y-4">{[
                    "AI-powered skill matching and recommendations",
                    "Portfolio optimization and learning suggestions",
                    "Scam detection and restricted communication",
                    "Startup, creator, and future founder pathways"
        ...
        <section className="relative isolate mx-auto my-24 max-w-[1300px] overflow-hidden rounded-[3rem] border border-white/10 bg-[#090e1a] px-6 py-24 shadow-[0_40px_100px_rgba(0,0,0,0.6)] sm:my-32 sm:px-16 sm:py-32">
          ...
          <div className="tv-reveal relative z-10 mx-auto max-w-3xl text-center"><h2 className="text-4xl font-black tracking-tight text-white sm:text-5xl">{"How TeenVerseHub fits together."}</h2><p className="mt-6 text-xl leading-relaxed text-slate-400">{"TeenVerseHub connects several systems into one teen-first platform."}</p></div>
