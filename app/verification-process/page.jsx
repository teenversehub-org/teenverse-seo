...
export const metadata = buildMetadata({
  title: "Verification Process | Skill Badges, KYC, Age Checks, and Trust Signals",
  description: "Learn how TeenVerseHub verification can combine skill tests, portfolio reviews, verified badges, age checks, KYC, and fraud monitoring for safer teen work.",
  path: "/verification-process",
  keywords: [
    "teen skill verification",
...
const pageSchema = {
  ...
  '@type': "WebPage",
  headline: "Verification Process | Skill Badges, KYC, Age Checks, and Trust Signals",
  name: "Verification Process | Skill Badges, KYC, Age Checks, and Trust Signals",
  description: "Learn how TeenVerseHub verification can combine skill tests, portfolio reviews, verified badges, age checks, KYC, and fraud monitoring for safer teen work.",
...
const pageFeatures = [
  {
    ...
    title: "AI Skill Testing",
    description: "Assessments and practical tests can check real ability in editing, design, coding, writing, AI workflows, and social media operations.",
    span: "md:col-span-7",
  ...
  },
  {
    ...
    description: "Portfolio samples make teen talent easier to evaluate and help clients compare proof instead of relying on claims.",
    span: "md:col-span-5",
    glow: "bg-blue-600/30",
  ...
  },
  {
    ...
    description: "Badges can signal completed checks, reviewed work, community trust, or specific skill strengths in a clear profile format.",
    span: "md:col-span-5",
  ...
  },
  {
    ...
    title: "Identity and Fraud Checks",
    description: "Age verification, KYC, suspicious activity monitoring, and account review systems help protect teens, clients, and payment workflows.",
    span: "md:col-span-7",
...
const roadmapSteps = [
  {
    ...
    points: [
      ...
      "Receive portfolio or community review",
      "Earn visible verified badges"
    ]
  },
  {
    title: "Trust Proof",
    ...
    points: [
      ...
      "Submit KYC where applicable",
      "Monitor suspicious activity",
      "Protect payout and client trust"
    ]
  }
]
    ...
    <>
      ...
      <main className="min-h-screen bg-[#f7f9ff] text-slate-950 selection:bg-indigo-200 selection:text-slate-950 transition-colors duration-500 dark:bg-[#030712] dark:text-white dark:selection:bg-indigo-500/30 dark:selection:text-indigo-200">
        <section className="relative isolate flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 pb-20 pt-32">
          ...
          <div className="tv-reveal relative z-10 mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-relaxed text-slate-600 dark:text-slate-400 md:text-xl">
              {"TeenVerseHub uses verification as a trust layer for young digital workers. Skill proof, portfolio reviews, identity checks, age verification, and verified badges can help teens earn credibility while reducing fraud for clients."}
            </p>
          ...
          <div className="tv-reveal relative z-10 mt-20 grid w-full max-w-4xl grid-cols-1 gap-px overflow-hidden rounded-3xl border border-indigo-100 bg-indigo-100/70 shadow-[0_24px_80px_rgba(79,70,229,0.12)] backdrop-blur-2xl dark:border-white/10 dark:bg-white/10 dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] sm:mt-24 sm:grid-cols-3">
            {[
              { label: "Skills", value: "Practical Tests" },
              { label: "Identity", value: "Age + KYC" },
              { label: "Trust", value: "Verified Badges" },
            ].map((stat, idx) => (
          ...
          <div className="mx-auto max-w-7xl">
            <div className="tv-reveal max-w-3xl">
              <h2 className="text-4xl font-black tracking-tight text-slate-950 dark:text-white sm:text-5xl">
                {"Verification turns young talent into trusted talent."}
              </h2>
              <p className="mt-6 text-xl leading-relaxed text-slate-600 dark:text-slate-400">
                {"TeenVerseHub can combine AI-based assessments, practical tasks, portfolio reviews, badges, community reviews, and KYC checks to make young talent easier to trust."}
              </p>
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 lg:gap-24">
              <div className="tv-reveal lg:sticky lg:top-32 lg:col-span-5 lg:h-max">
                <h2 className="text-4xl font-black leading-tight tracking-tight text-slate-950 dark:text-white sm:text-5xl">{"Trust grows when skill and identity are visible."}</h2>
                <p className="mt-6 text-lg leading-relaxed text-slate-600 dark:text-slate-400">{"Many teenagers have strong skills but no professional credibility. Verification helps turn hidden talent into trusted opportunity through practical proof and safer account checks."}</p>
              </div>
              <div className="flex flex-col gap-8 lg:col-span-7">
                <div className="tv-card-motion tv-reveal relative rounded-[2rem] border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white p-7 shadow-2xl shadow-indigo-100/70 backdrop-blur-xl dark:border-indigo-500/20 dark:bg-gradient-to-br dark:from-indigo-950/40 dark:to-slate-900/40 dark:shadow-2xl sm:rounded-[2.5rem] sm:p-10">
                  <div className="mb-6 flex items-center gap-4 border-b border-slate-200 pb-6 dark:border-white/10"><Briefcase className="h-8 w-8 text-indigo-400" /><h3 className="text-2xl font-black text-slate-950 dark:text-white">{"Verification Signals"}</h3></div>
                ...
                <div className="tv-card-motion tv-reveal relative rounded-[2rem] border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-7 shadow-2xl shadow-emerald-100/70 backdrop-blur-xl dark:border-emerald-500/20 dark:bg-gradient-to-br dark:from-emerald-950/40 dark:to-slate-900/40 dark:shadow-2xl sm:rounded-[2.5rem] sm:p-10">
                  <div className="mb-6 flex items-center gap-4 border-b border-slate-200 pb-6 dark:border-white/10"><TrendingUp className="h-8 w-8 text-emerald-400" /><h3 className="text-2xl font-black text-slate-950 dark:text-white">{"Why Verification Matters"}</h3></div>
                  <p className="mb-6 text-lg text-slate-700 dark:text-slate-300">{"Skill verification helps clients trust younger freelancers and helps teens compete based on work quality instead of age bias."}</p>
                  <ul className="space-y-4">{[
                    "Improves client confidence",
                    "Reduces scams and fake accounts",
                    "Supports secure payouts",
        ...
        <section className="relative isolate mx-auto my-24 max-w-[1300px] overflow-hidden rounded-[3rem] border border-white/10 bg-[#090e1a] px-6 py-24 shadow-[0_40px_100px_rgba(0,0,0,0.6)] sm:my-32 sm:px-16 sm:py-32">
          ...
          <div className="tv-reveal relative z-10 mx-auto max-w-3xl text-center"><h2 className="text-4xl font-black tracking-tight text-white sm:text-5xl">{"Verification roadmap for trust."}</h2><p className="mt-6 text-xl leading-relaxed text-slate-400">{"Verification should be practical, age-aware, and tied to real marketplace trust."}</p></div>
